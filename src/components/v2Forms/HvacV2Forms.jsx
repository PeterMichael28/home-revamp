...
import { HvacV2PropertyDetails } from "../FormPage/v2/hvac";

const HvacV2Forms = ({ slug }) => {
  ...
  const STEPS = [
    ...
    {
      label: "Form3",
      component: (props) => <HvacV2PropertyDetails props={props} />,
    },
    {
      label: "Form4",
    ...
    },
    {
      ...
      component: (props) => (
        <RoofingV2ProjectDetails
          props={props}
          slug={slug}
          projectTimelineData={["Immediately", "1-3 months", "3-6 months", "Within a Year", "Not Sure"]}
