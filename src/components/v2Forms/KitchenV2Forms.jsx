...
import { KitchenV2PropertyDetails } from "../FormPage/v2/kitchen";

const KitchenV2Forms = ({ slug }) => {
  ...
  const STEPS = [
    ...
    {
      label: "Form3",
      component: (props) => <KitchenV2PropertyDetails props={props} />,
    },
    {
      label: "Form4",
