...
import { PlumbingV2PropertyDetails } from "../FormPage/v2/plumbing";

const PlumbingV2Forms = ({ slug }) => {
  ...
  const STEPS = [
    ...
    {
      label: "Form3",
      component: (props) => <PlumbingV2PropertyDetails props={props} />,
    },
    {
      label: "Form4",
...
export default PlumbingV2Forms;
