...
import { GutterV2PropertyDetails } from "../FormPage/v2/gutter";

const GutterV2Forms = ({ slug }) => {
  ...
  const STEPS = [
    ...
    {
      label: "Form3",
      component: (props) => <GutterV2PropertyDetails props={props} />,
    },
    {
      label: "Form4",
