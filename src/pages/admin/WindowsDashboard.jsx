...
const WindowsDashboard = () => {
  ...
  useEffect(() => {
    ...
    const endpointWithParams = `${url}/api/window-service-filter/?page=${page}&${searchParams.toString()}`;
  ...
  return (
    <div>
      ...
      <div className="mt-3 pb-8 min-w-[1000px] overflow-x-auto">
        <TableDataComp
          data={data}
          csv="windowLeadsData.csv"
          service="windows"
          page={page}
          setPage={setPage}
